...
const mockProducts = [
  ...
  {
    id: 'pn_pod_1',
    name: 'پاد سیستم لوکس شیخ مدل Royal Vape X1',
    category: 'OTHERS',
    categoryId: 'cat_nicotine',
    description: 'پاد سیستم حرفه‌ای و لوکس با باتری قدرتمند ۱۰۰۰ میلی‌آمپر، بدنه آلیاژ روی با گلد تریم و کام‌دهی فوق‌العاده نرم.',
    basePrice: 3850000,
    baseUnitId: 'u3',
    quantity: 40,
    status: 'ACTIVE',
    ...
    isBestSeller: true,
    isAmazing: true,
    categoryType: 'SheikhNicotine',
    slug: 'royal-vape-x1-pod-device',
    seoTitle: 'پاد سیستم لوکس شیخ مدل Royal Vape X1 | ویپینگ ممتاز',
    seoDescription: 'خرید پاد سیستم لوکس شیخ مدل Royal Vape X1 با بدنه طلایی و باتری ۱۰۰۰ میلی‌آمپری.',
    brand: 'Sheikh Shop',
    sku: 'SH-POD-RX1',
    features: ['باتری ۱۰۰۰ میلی‌آمپر ساعت', 'شارژ سریع Type-C', 'بدنه لوکس با روکش طلایی'],
    tags: ['پاد سیستم', 'ویپ', 'نیکوتین'],
    weight: 0.12,
    warranty: 'ضمانت طلایی ۱۲ ماهه شیخ',
    origin: 'ایران',
    color: 'مشکی طلایی',
    baseUnit: mockUnits[2],
    categoryRelation: mockCategories[4],
    images: [{ id: 'img_pn_pod1', image: '/nicotine.webp', secureUrl: '/nicotine.webp', createdAt: new Date() }],
    discounts: [],
    units: [
      { id: 'pud_pod_1', productId: 'pn_pod_1', name: 'Piece', price: 3850000, unitId: 'u3', unit: mockUnits[2], isActive: true, stock: 40, createdAt: new Date(), updatedAt: new Date() }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    id: 'pn_salt_1',
    name: 'ای-لیکوئید سالت نیکوتین شیخ مدل Golden Mango 30ml',
    category: 'OTHERS',
    categoryId: 'cat_nicotine',
    description: 'سالت نیکوتین ۳۰ میلی‌لیتری پریمیوم با طعم انبه طلایی و طراوت استوایی خالص، غلظت ۳۰ میلی‌گرم نیکوتین ناعم.',
    basePrice: 950000,
    baseUnitId: 'u3',
    quantity: 85,
    status: 'ACTIVE',
    ...
    isAmazing: true,
    categoryType: 'SheikhNicotine',
    slug: 'golden-mango-nicotine-salt-30ml',
    seoTitle: 'سالت نیکوتین شیخ مدل Golden Mango 30ml | طعم انبه طلایی',
    seoDescription: 'خرید سالت نیکوتین انبه طلایی ۳۰ میلی‌لیتری شیخ با طعم طبیعی و طراوت بالا.',
    brand: 'Sheikh Shop',
    sku: 'SH-SALT-GM30',
    features: ['حجم ۳۰ میلی‌لیتر', 'غلظت ۳۰ میلی‌گرم', 'طعم ماندگار و طبیعی انبه'],
    tags: ['سالت نیکوتین', 'ای-لیکوئید', 'جویس'],
    weight: 0.05,
    warranty: 'اصالت و کیفیت تضمین‌شده',
    origin: 'ایران',
    color: 'طلایی شفاف',
    baseUnit: mockUnits[2],
    categoryRelation: mockCategories[4],
    images: [{ id: 'img_pn_salt1', image: '/nicotine.webp', secureUrl: '/nicotine.webp', createdAt: new Date() }],
    discounts: [],
    units: [
      { id: 'pud_salt_1', productId: 'pn_salt_1', name: 'Piece', price: 950000, unitId: 'u3', unit: mockUnits[2], isActive: true, stock: 85, createdAt: new Date(), updatedAt: new Date() }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    id: 'pg_clipper_1',
    name: 'ماشین اصلاح حرفه‌ای سر و صورت شیخ مدل Clipper Pro 9000',
    category: 'OTHERS',
    categoryId: 'cat_grooming',
    description: 'ماشین اصلاح سر و صورت فول ارگونومیک با تیغه‌های تیتانیوم خودتیزشونده، موتور خطی پرقدرت و نمایشگر شارژ دیجیتال LED.',
    basePrice: 5800000,
    baseUnitId: 'u3',
    quantity: 35,
    status: 'ACTIVE',
    ...
    isBestSeller: true,
    isAmazing: true,
    categoryType: 'SheikhGrooming',
    slug: 'clipper-pro-9000-grooming',
    seoTitle: 'ماشین اصلاح حرفه‌ای شیخ Clipper Pro 9000 | موزر قدرتمند',
    seoDescription: 'خرید ماشین اصلاح سر و صورت حرفه‌ای شیخ مدل Clipper Pro 9000 با تیغه‌های تیتانیوم.',
    brand: 'Sheikh Shop',
    sku: 'SH-CLIP-P9000',
    features: ['تیغه‌های تیتانیوم ضدزنگ', 'موتور خطی ۷۵۰ دور در دقیقه', 'شارژدهی ۱۸۰ دقیقه‌ای'],
    tags: ['ماشین اصلاح', 'موزر', 'گرومینگ'],
    weight: 0.45,
    warranty: 'ضمانت طلایی ۲۴ ماهه شیخ',
    origin: 'ایران',
    color: 'مشکی کروم طلایی',
    baseUnit: mockUnits[2],
    categoryRelation: mockCategories[5],
    images: [{ id: 'img_pg_clipper1', image: '/grooming.webp', secureUrl: '/grooming.webp', createdAt: new Date() }],
    discounts: [],
    units: [
      { id: 'pud_clipper_1', productId: 'pg_clipper_1', name: 'Piece', price: 5800000, unitId: 'u3', unit: mockUnits[2], isActive: true, stock: 35, createdAt: new Date(), updatedAt: new Date() }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  },
  {
    id: 'pg_trimmer_1',
    name: 'تریمر خط‌زن و اصلاح ریش شیخ مدل Precision Gold',
    category: 'OTHERS',
    categoryId: 'cat_grooming',
    description: 'تریمر خط‌زن مجهز به تیغه T-Blade استیل و روکش طلا برای خط‌زنی دقیق ریش، آنکارد و آراستگی دقیق.',
    basePrice: 4200000,
    baseUnitId: 'u3',
    quantity: 50,
    status: 'ACTIVE',
    ...
    isAmazing: true,
    categoryType: 'SheikhGrooming',
    slug: 'precision-gold-beard-trimmer',
    seoTitle: 'تریمر خط‌زن ریش شیخ Precision Gold | اصلاح دقیق',
    seoDescription: 'خرید تریمر خط‌زن ریش شیخ Precision Gold با تیغه T-Blade طلایی.',
    brand: 'Sheikh Shop',
    sku: 'SH-TRIM-PGOLD',
    features: ['تیغه T-Blade طلایی استیل', 'طراحی صفر زن دقیق', 'بدنه تمام فلزی مقاوم'],
    tags: ['تریمر', 'خط زن', 'اصلاح ریش'],
    weight: 0.28,
    warranty: 'ضمانت طلایی ۲۴ ماهه شیخ',
    origin: 'ایران',
    color: 'طلایی بوهو',
    baseUnit: mockUnits[2],
    categoryRelation: mockCategories[5],
    images: [{ id: 'img_pg_trimmer1', image: '/grooming.webp', secureUrl: '/grooming.webp', createdAt: new Date() }],
    discounts: [],
    units: [
      { id: 'pud_trimmer_1', productId: 'pg_trimmer_1', name: 'Piece', price: 4200000, unitId: 'u3', unit: mockUnits[2], isActive: true, stock: 50, createdAt: new Date(), updatedAt: new Date() }
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
  }
