...
export default function SheikhGroomingEmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-20 px-4 text-center" dir="rtl">
      ...
      <h2 className="text-2xl font-bold text-white mb-3">محصولی در بخش شیخ گرومینگ یافت نشد</h2>
      <p className="text-gray-400 text-sm max-w-md mb-8 leading-relaxed">
        به زودی حرفه‌ای‌ترین تجهیزات اصلاح، ماشین‌های موزر لوکس و تریمرهای پیرایش شخصی در دسته‌بندی شیخ گرومینگ عرضه خواهند شد.
      </p>
      <Link
        href="/products"
