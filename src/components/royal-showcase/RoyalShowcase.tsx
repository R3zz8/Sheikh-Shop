...
// Dynamic imports for 3D subcomponents
const RoyalShowcasePusherCanvas = dynamic(() => import('./RoyalShowcasePusherCanvas'), {
  ssr: false,
  loading: () => <StaticSheikhFallback align="left" />,
});

const RoyalShowcaseReceiverCanvas = dynamic(() => import('./RoyalShowcaseReceiverCanvas'), {
  ssr: false,
  loading: () => <StaticSheikhFallback align="right" />,
});
            ...
            {webGLSupported && inView && !isMobile ? (
              <div className="w-full h-full pointer-events-auto relative overflow-hidden">
                <ThreeErrorBoundary fallback={<StaticSheikhFallback align="left" />}>
                  <RoyalShowcasePusherCanvas isPushing={isPushing} />
                </ThreeErrorBoundary>
              </div>
            ) : (
            ...
            {webGLSupported && inView && !isMobile ? (
              <div className="w-full h-full pointer-events-auto relative overflow-hidden">
                <ThreeErrorBoundary fallback={<StaticSheikhFallback align="right" />}>
                  <RoyalShowcaseReceiverCanvas isReceiving={isReceiving} />
                </ThreeErrorBoundary>
              </div>
            ) : (
