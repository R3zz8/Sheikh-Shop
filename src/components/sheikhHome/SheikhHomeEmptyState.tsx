...
export default function SheikhHomeEmptyState() {
  return (
    <div className="w-full max-w-2xl mx-auto py-12 px-4 sm:px-6 text-center select-none font-vazirmatn" dir="rtl">
      ...
      >
        ...
        <h3 className="text-xl sm:text-2xl font-black text-white mb-3">
          محصولات لوازم خانگی شیخ به زودی اضافه خواهند شد.
        </h3>
        <p className="text-gray-400 text-xs sm:text-sm max-w-md mx-auto leading-relaxed mb-8">
          در حال تدارک و افزودن بهترین و لوکس‌ترین تجهیزات آشپزخانه هوشمند، یخچال‌های گلد تریم، ماشین‌های لباسشویی دایرکت درایو بی‌صدا و لوازم برقی مجلل برای شما هستیم.
        </p>
