...
// Import custom Sheikh Nicotine page sections
import SheikhNicotineEmptyState from '@/components/sheikhNicotine/SheikhNicotineEmptyState';
...
/**
 * Generate metadata for the Sheikh Nicotine page
 */
export async function generateMetadata(): Promise<Metadata> {
  const baseUrl = getBaseUrl();
  const canonicalPath = '/sheikh-nicotine';
  const canonicalUrl = `${baseUrl}${canonicalPath}`;

  return {
    title: 'شیخ نیکوتین | فروشگاه بزرگ شیخ',
    description: 'مجموعه تخصصی و لوکس ویپ، پاد سیستم، ای-لیکوئید و محصولات نیکوتین با طراحی مدرن و کیفیت عالی در فروشگاه بزرگ شیخ.',
    keywords: [
      'شیخ نیکوتین',
      'پاد سیستم لوکس',
      'ویپ لوکس',
    ...
    openGraph: {
      title: 'شیخ نیکوتین | فروشگاه بزرگ شیخ',
      description: 'مجموعه گزینش‌شده و لوکس محصولات ویپ، پاد سیستم و جویس‌های ممتاز.',
      type: 'website',
      url: canonicalUrl,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: 'مجموعه محصولات نیکوتین شیخ - فروشگاه شیخ',
        },
      ],
    },
    twitter: {
      ...
      title: 'شیخ نیکوتین | فروشگاه بزرگ شیخ',
      description: 'کامل‌ترین مجموعه محصولات نیکوتین و ویپینگ لوکس فروشگاه شیخ.',
...
export default async function SheikhNicotinePage() {
  try {
    const [data, units] = await Promise.all([
      getProductsByCategory(ProductCategoryType.SheikhNicotine),
    ...
    if (!data || !Array.isArray(data)) {
      console.error('Invalid nicotine products list format received');
    ...
    const breadcrumbs = [
      ...
      { name: 'شیخ نیکوتین', url: '/sheikh-nicotine' },
    ];
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#0a0503] via-[#120703] to-[#0a0503] text-white">
        ...
        <div id="nicotine-products-section" className="scroll-mt-24 pb-16">
          {serializedProducts.length > 0 ? (
            <ProductListView
              products={serializedProducts}
              units={serializedUnits}
              title="شیخ نیکوتین"
              subtitle="مجموعه‌ای تخصصی از برترین پاد سیستم‌ها، ویپ‌های مدرن و ای-لیکوئیدهای ممتاز."
              variant="nicotine"
            />
          ) : (
            <SheikhNicotineEmptyState />
          )}
        </div>
      </div>
    );
    ...
    console.error('Failed to load Sheikh Nicotine page:', {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-stone-950 font-vazirmatn" dir="rtl">
        <div className="text-center p-8 border border-amber-500/10 bg-[#140b07]/80 rounded-[2rem] max-w-2xl mx-auto shadow-2xl">
          ...
          <h1 className="text-xl font-bold text-white mb-2">خطا در بارگذاری شیخ نیکوتین</h1>
          <p className="text-gray-400 text-sm mb-6">
            در بارگذاری صفحه شیخ نیکوتین مشکلی موقت پیش آمده است. لطفا صفحه را مجددا بارگذاری نمایید.
          </p>
