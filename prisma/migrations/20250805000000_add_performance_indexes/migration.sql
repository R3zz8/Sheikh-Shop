...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_session_expires_at" ON "Session"("expiresAt");
...
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_article_slug" ON "Article"("slug");
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_article_status" ON "Article"("status");
CREATE INDEX CONCURRENTLY IF NOT EXISTS "idx_article_author_id" ON "Article"("authorId"); 